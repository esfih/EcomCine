<?php
/**
 * Compatibility adapter: checkout policy via WooCommerce filters (tvbm-004).
 *
...
class TVBM_Compat_Checkout_Policy implements TVBM_Checkout_Policy {
	...
	public function set_order_modal_flag( $order ): void {
		if ( $order instanceof \WC_Order ) {
			$order->update_meta_data( '_tm_modal_checkout', '1' );
		}
	}
}
