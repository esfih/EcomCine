<?php
/**
 * Default-WP adapter: login handler.
 *
 * Functionally identical to the compat adapter — both use wp_signon.
 * Separated so the REST-endpoint replacement pattern can be wired here
 * later without modifying the compat adapter.
 *
...
class TAP_WP_Login_Handler implements TAP_Login_Handler {
