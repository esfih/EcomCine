<?php
/**
 * EcomCine vendor listing wrapper.
 *
 * Mirrors Dokan's store-lists.php contract, but resolves through the
 * plugin-owned vendor-store namespace so the vendor-store migration
