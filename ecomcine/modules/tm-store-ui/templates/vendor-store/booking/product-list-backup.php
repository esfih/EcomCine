...
<header class="dokan-dashboard-header">
    ...
    <h1 class="entry-title"><?php echo esc_html( $title ); ?>
        <span>
            ...
            <a href="<?php echo esc_url( $booking_url . 'add-booking' ); ?>" class="dokan-btn dokan-right dokan-add-new-product"><?php echo TM_Icons::svg( 'calendar-alt' ); ?> <?php esc_html_e( 'Add Booking', 'dokan' ); ?></a>
            <?php endif; ?>
        </span>
        <span class="dokan-add-product-link">
            <a href="<?php echo esc_url( $booking_url . 'new-product' ); ?>" class="dokan-btn dokan-btn-theme dokan-right dokan-add-new-product dokan-add-new-booking-product"><?php echo TM_Icons::svg( 'briefcase' ); ?>&nbsp; <?php esc_html_e( 'Add New Booking Product', 'dokan' ); ?></a>
        </span>
    </h1>
    <?php } ?>
...
<div class="dokan-product-listing">
    ...
    <article class="dokan-product-listing-area">
        ...
        <table class="dokan-table dokan-table-striped product-listing-table" id="dokan-product-list-table">
            ...
            <tbody>
                ...
                if ( $product_query->have_posts() ) {
                    ...
                    <tr>
                        <td colspan="6">
                            <?php esc_html_e( 'No booking products found', 'dokan' ); ?>
                        </td>
                    </tr>
                <?php }
        ...
        <?php dokan_product_pagination( $product_query->max_num_pages, $pagenum ); ?>
    </article>
</div>
