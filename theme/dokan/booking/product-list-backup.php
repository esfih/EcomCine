...
<header class="dokan-dashboard-header">
    ...
    <h1 class="entry-title"><?php echo esc_html( $title ); ?>
        ...
        <span class="dokan-add-product-link">
            <a href="<?php echo esc_url( $booking_url . 'new-product' ); ?>" class="dokan-btn dokan-btn-theme dokan-right dokan-add-new-product dokan-add-new-booking-product"><i class="fas fa-briefcase">&nbsp;</i> <?php esc_html_e( 'Add New Booking Product', 'dokan' ); ?></a>
        </span>
    </h1>
    <?php } ?>
